...
package gameObjects
{
	...
	/**
	 * Esta clase representa las particulas que son utilizadas en los diversos efectos del juego
	 * como lo son los poderes de la bruja, se ha creado utilizando el Particle Systems extension
	 * de Starling Framework.
	 * 
	 * @author
	 * 
	 */
